...
dependencies {
  paths = ["../aws-data", "../symbiosis-vpc", "../symbiosis-asg-sg"]
}
...
dependency "symbiosis-asg-sg" {
  config_path = "../symbiosis-asg-sg"
}
...
inputs = {
  ...
  # type: list(string)
  security_groups = [dependency.symbiosis-asg-sg.outputs.security_group_id]
  ...
  # type: list(string)
  vpc_zone_identifier = dependency.symbiosis-vpc.outputs.public_subnets
