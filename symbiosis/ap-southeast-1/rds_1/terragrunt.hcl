...
dependencies {
  paths = ["../symbiosis-vpc", "../symbiosis-rds-sg"]
}
...
dependency "symbiosis-rds-sg" {
  config_path = "../symbiosis-rds-sg"
}
...
inputs = {
  ...
  # type: string
  db_subnet_group_name = dependency.symbiosis-vpc.outputs.database_subnet_group
  ...
  # type: list(string)
  vpc_security_group_ids = [dependency.symbiosis-rds-sg.outputs.security_group_id]
